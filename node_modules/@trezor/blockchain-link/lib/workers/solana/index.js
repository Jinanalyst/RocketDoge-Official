...
const pushTransaction = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield api.sendRawTransaction(txBuffer, {
            skipPreflight: true,
            maxRetries: 0,
        });
        ...
        if (error instanceof web3_js_1.SendTransactionError &&
            ((_a = error === null || error === void 0 ? void 0 : error.transactionError) === null || _a === void 0 ? void 0 : _a.message) === 'Internal error') {
...
const getAccountInfo = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const allTxIds = details === 'basic' || details === 'txs' || details === 'txids'
        ? Array.from(new Set((yield Promise.all(allAccounts.map(account => getAllSignatures(api, account))))
            .flat()
...
class SolanaWorker extends baseWorker_1.BaseWorker {
    ...
    tryConnect(url) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const api = new web3_js_1.Connection(url, {
            ...
            this.isTestnet =
                (yield api.getGenesisHash()) !== '5eykt4UsFv8P8NJdTREpY1vzqKqZKvdpKuc147dw2N9d';
