    ...
    read(path, signal) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                (_b = this.logger) === null || _b === void 0 ? void 0 : _b.debug(`usb: device.transferIn done. status: ${res.status}, byteLength: ${(_c = res.data) === null || _c === void 0 ? void 0 : _c.byteLength}. device: ${this.formatDeviceForLog(device)}`);
    ...
    write(path, buffer, signal) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                (_b = this.logger) === null || _b === void 0 ? void 0 : _b.debug(`usb: device.transferOut done. device: ${this.formatDeviceForLog(device)}`);
                if (result.status !== 'ok') {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (first) {
                try {
                    ...
                    (_e = this.logger) === null || _e === void 0 ? void 0 : _e.debug(`usb: device.selectConfiguration done: ${constants_1.CONFIGURATION_ID}. device: ${this.formatDeviceForLog(device)}`);
                }
                catch (err) {
                ...
                try {
                    ...
                    (_h = this.logger) === null || _h === void 0 ? void 0 : _h.debug(`usb: device.reset done. device: ${this.formatDeviceForLog(device)}`);
                }
                catch (err) {
            ...
            try {
                ...
                (_l = this.logger) === null || _l === void 0 ? void 0 : _l.debug(`usb: device.claimInterface done: ${interfaceId}. device: ${this.formatDeviceForLog(device)}`);
            }
            catch (err) {
    ...
    createDevices(devices, signal) {
        return this.synchronizeCreateDevices(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            hidDevices.forEach(device => {
                var _a;
                (_a = this.logger) === null || _a === void 0 ? void 0 : _a.error(`usb: unreadable hid device connected. device: ${this.formatDeviceForLog(device)}`);
            });
